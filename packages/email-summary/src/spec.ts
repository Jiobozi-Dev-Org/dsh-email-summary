...
export const DEFAULT_EMAIL_SETTINGS: EmailSummarySettings = {
  provider: 'qq',
...
export const EmailSummarySettingsSchema: z<EmailSummarySettings> = z.object({
  provider: z.string(),
  smtpHost: z.string(),
  smtpPort: z.number(),
  secure: z.string(),
...
export function presetById(id: string): EmailProviderPreset | undefined {
